...
# pay
# cleos transfer player1 bitsfleamain "101.0000 EOS" "payorder:0x8a082c5e000000000200000000000000" -p player1
# cleos get currency balance eosio.token player1 EOS
# cleos get currency balance eosio.token bitsfleamain EOS
# cleos push action bitsfleamain shipment '[0,"player",0x8a082c5e000000000200000000000000,"229988222"]' -p player
# cleos push action bitsfleamain conreceipt '[2,"player1",0x8a082c5e000000000200000000000000]' -p player1
