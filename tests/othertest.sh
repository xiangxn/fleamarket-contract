...
# cleos transfer player1 bitsfleamain "101.0000 EOS" "payorder:36893488153295852907" -p player1 -c bitsfleamain
...
# cleos push action bitsfleamain bindaddr '[0,"player","4,EOS","necklace"]' -p player
# cleos push action bitsfleamain bindaddr '[0,"player","8,NULS","necklace"]' -p player

# cleos push action bitsfleamain shipment '[0,"player","36893488153295852907","229988222"]' -p player
# cleos push action bitsfleamain conreceipt '[2,"player1","36893488153295852907"]' -p player1
# cleos push action bitsfleamain returns '[2,"player1","36893488153295852907","商品与描述不符"]' -p player1
# cleos push action bitsfleamain reshipment '[2,"player1","36893488153295852907","229988223"]' -p player1
# cleos push action bitsfleamain reconreceipt '[0,"player","36893488153295852907"]' -p player
