...
cleos push action bitsfleamain publish '[0,{"pid":0,"uid":0,"title":"title test","description":"description 测试","photos":"photos 测试","category":0,"status":0,"is_new":false,"is_returns":true,"reviewer":0,"sale_method":0,"price":"1.0000 EOS","transaction_method":1,"postage":"0.0100 EOS","position":"位置","release_time":"2020-01-20T00:00:00"},{"id":0,"pid":0,"security":"1.0000 EOS","markup":"1.0000 EOS","current_price":"1.0000 EOS","auction_times":0,"last_price_user":0,"start_time":"2020-01-20T00:00:00","end_time":"2020-01-22T00:00:00"}]' -p bitsfleamain &&
...
# cleos transfer player1 bitsfleamain "1.0100 EOS" "payorder:36893488153295913705" -p player1 -c bitsfleamain
...
# cleos push action bitsfleamain shipment '[0,"player","36893488153295913705","229988222"]' -p player
# cleos push action bitsfleamain conreceipt '[2,"player1","36893488153295913705"]' -p player1
# cleos push action bitsfleamain returns '[2,"player1","36893488153295913705","商品与描述不符"]' -p player1
# cleos push action bitsfleamain reshipment '[2,"player1","36893488153295913705","229988223"]' -p player1
# cleos push action bitsfleamain reconreceipt '[0,"player","36893488153295913705"]' -p player

# cleos transfer player bitsfleamain "50.0000 EOS" "withdraw:0x165a3e5e0100000" -p player -c bitsfleamain
